"""
Validation Backtest (TOLERANCE VERSION)
========================================
...
Based on: validation_backtest.py (original)
Author: Harim Choi
Date: 2025-12-20
"""
...
VAL_DATA = ROOT / 'data' / 'processed' / 'val.csv'
VAL_FEATURES = ROOT / 'analysis_results' / 'feature_sample_val.csv'
...
def run_validation_backtest(target_company, max_auctions=None):
    """Run validation backtest with TOLERANCE-based bid selection."""
    print("="*70)
    print(f"VALIDATION BACKTEST (TOLERANCE={TOLERANCE}): {target_company}")
    print("="*70)
    print()
    ...
    print()
    print("="*70)
    print(f"VALIDATION RESULTS (TOLERANCE={TOLERANCE})")
    print("="*70)
    print()
    ...
    results_df.to_csv(out_dir / f'validation_tolerance_{target_company}.csv', index=False)
    print(f"Saved: {out_dir / f'validation_tolerance_{target_company}.csv'}")
    print("="*70)
